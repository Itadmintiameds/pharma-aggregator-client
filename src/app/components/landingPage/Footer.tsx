        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
          ...
          <div className="md:col-span-8">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-12">
              {/* Quick Links */}
              <div>
                <h3 className="text-white text-xl font-semibold mb-6 pb-2 border-b border-neutral-900">
                  Company
                </h3>
                  ...
                  {[
                    ...
                    <li key={item.name}>
                      <motion.div whileHover={{ x: 5 }}>
                        <Link
                          href={item.href}
                          className="text-neutral-50 hover:text-primary-400 transition-colors duration-200 flex items-center group"
                        >
              ...
              <div>
                ...
                <address className="not-italic space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="text-neutral-50 text-sm leading-relaxed hover:text-primary-400 transition-colors">
                  ...
                  <div className="flex items-center">
                    ...
                    <div
                      className="text-neutral-50 hover:text-primary-400 transition-colors text-lg font-medium"
                    >
                      Help Center
                    </div>
                  </div>
