...
//         <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
//           <path
//             d="M2.25 4.5H15.75M5.25 9H12.75M8.25 13.5H9.75"
//             stroke="#1E1E1D"
//             strokeWidth="1.5"
//             strokeLinecap="round"
//           />
...
//     new Set(
//       data.map((p) => p.categoryId).filter((id): id is number => id != null),
//     ),
//   );
...
//       result = result.filter(
//         (p) => (p.pricingDetails?.[0]?.stockQuantity ?? 0) > 0,
//       );
...
//       result.sort(
//         (a, b) =>
//           (a.pricingDetails?.[0]?.mrp ?? 0) - (b.pricingDetails?.[0]?.mrp ?? 0),
//       );
//     else if (sortValue === "price_desc")
//       result.sort(
//         (a, b) =>
//           (b.pricingDetails?.[0]?.mrp ?? 0) - (a.pricingDetails?.[0]?.mrp ?? 0),
//       );
//     else if (sortValue === "stock_asc")
//       result.sort(
//         (a, b) =>
//           (a.pricingDetails?.[0]?.stockQuantity ?? 0) -
//           (b.pricingDetails?.[0]?.stockQuantity ?? 0),
//       );
