...
const NonConsumableForm = ({ productId, mode = "create", onSubmitSuccess }: NonConsumableFormProps) => {
  ...
  const validate = (): Record<string, string> => {
    ...
    if (!form.intendedUse.trim()) e.intendedUse = "Intended use required";
    if (!form.keyFeatures.trim()) e.keyFeatures = "Key features required";
    if (!form.safetyInstructions.trim()) e.safetyInstructions = "Safety instructions required";
      ...
      <div className="border border-neutral-200 rounded-xl p-4 sm:p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 mt-8 gap-y-4">
          ...
          <div className="flex flex-col gap-1">
            ...
            <Select options={deviceClassOptions}
          ...
          <div className="flex flex-col gap-1">
            ...
            <Select options={powerSourceOptions}
          ...
          <Input label="Warranty Period (months)" name="warrantyPeriod" placeholder="e.g., 12"
            onChange={handleChange} value={form.warrantyPeriod} error={errors.warrantyPeriod} />
          ...
          <div className="flex flex-col gap-1">
            ...
            <Select options={storageConditionOptions}
      ...
      <div className="border border-neutral-200 rounded-xl p-4 sm:p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6 mt-8">
          <div className="flex flex-col gap-1">
            ...
            <Select options={packTypeApiOptions}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          ...
          <Input label="Stock Quantity" name="stockQuantity"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          ...
          <Input label="Selling Price (per pack size)" name="sellingPrice" onChange={handleChange} value={form.sellingPrice} error={errors.sellingPrice} required />
