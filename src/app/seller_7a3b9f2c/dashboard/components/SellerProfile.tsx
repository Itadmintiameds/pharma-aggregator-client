...
// working code without validationnn...........
...
//     // Check if the value already has +91 prefix from display
//     let cleanValue = value;
//     if (cleanValue.startsWith('91')) {
//       cleanValue = cleanValue.substring(2);
//     }
...
//                     <div className="relative" ref={productDropdownRef}>
//                       <div
//                         className={`w-full h-[52px] px-4 rounded-md border flex items-center justify-between ${!editingSection ? 'bg-pneutral-50 border-pneutral-100 cursor-not-allowed' : 'bg-base-white border-pneutral-200 cursor-pointer hover:border-secondary-500'}`}
//                         onClick={() => {
//                           if (editingSection && !loadingStates.productTypes) {
//                             setIsProductDropdownOpen(!isProductDropdownOpen);
//                           }
...
//               key={productName}
//               id={`license-section-${productName.replace(/\s/g, '-')}`}
//               className={`${hasLicenseError ? 'border-2 border-warning-300 rounded-md' : ''}`}
//             >
//               <SectionCard
//                 title={`${productName} License Details`}
//                 icon={<HiOutlineDocumentCheck size={20} />}
...
//                           className={`w-full h-[52px] px-4 rounded-md text-p4 font-body font-regular uppercase pr-10
//                             ${editingSection
//                               ? `bg-base-white border border-pneutral-200 focus:outline-none focus:ring-2 focus:ring-secondary-500 ${licenseErrors[productName] || licenseExistsError[productName] ? 'border-warning-500' : ''} ${licenseErrors[productName] || licenseExistsError[productName] ? 'text-pneutral-800' : 'text-pneutral-800'}`
//                               : "bg-pneutral-50 border border-pneutral-100 cursor-not-allowed text-pneutral-800"
//                             }`}
//                         />
//                         {isCheckingLicense[productName] && (
...
// old code as per old global css dated 21.05.2026.................
...
//       if (emailElement) {
//         emailElement.scrollIntoView({ behavior: 'smooth', block: 'center' });
//         emailElement.classList.add('border-warning-500', 'ring-2', 'ring-warning-200', 'rounded-lg', 'p-2');
//         setTimeout(() => {
//           emailElement.classList.remove('border-warning-500', 'ring-2', 'ring-warning-200', 'rounded-lg', 'p-2');
//         }, 3000);
//       } else {
//         window.scrollTo({ top: 0, behavior: 'smooth' });
//       }
...
//       if (phoneElement) {
//         phoneElement.scrollIntoView({ behavior: 'smooth', block: 'center' });
//         phoneElement.classList.add('border-warning-500', 'ring-2', 'ring-warning-200', 'rounded-lg', 'p-2');
//         setTimeout(() => {
//           phoneElement.classList.remove('border-warning-500', 'ring-2', 'ring-warning-200', 'rounded-lg', 'p-2');
//         }, 3000);
//       } else {
//         window.scrollTo({ top: 0, behavior: 'smooth' });
//       }
...
//       if (element) {
//         element.scrollIntoView({ behavior: 'smooth', block: 'center' });
//         element.classList.add('border-warning-500', 'ring-2', 'ring-warning-200', 'rounded-lg');
//         setTimeout(() => {
//           element.classList.remove('border-warning-500', 'ring-2', 'ring-warning-200', 'rounded-lg');
//         }, 3000);
//       } else {
//         window.scrollTo({ top: 0, behavior: 'smooth' });
//       }
...
//       if (gstElement) {
//         gstElement.scrollIntoView({ behavior: 'smooth', block: 'center' });
//         gstElement.classList.add('border-warning-500', 'ring-2', 'ring-warning-200', 'rounded-lg');
//         setTimeout(() => {
//           gstElement.classList.remove('border-warning-500', 'ring-2', 'ring-warning-200', 'rounded-lg');
//         }, 3000);
//       } else {
//         window.scrollTo({ top: 0, behavior: 'smooth' });
//       }
...
//       <div className="bg-pneutral-50 min-h-screen w-full p-6 space-y-6">
//         <div className="animate-pulse space-y-6">
//           <div className="h-64 bg-sneutral-100 rounded-lg"></div>
//           <div className="h-48 bg-sneutral-100 rounded-lg"></div>
//           <div className="h-56 bg-sneutral-100 rounded-lg"></div>
//           <div className="h-40 bg-sneutral-100 rounded-lg"></div>
//           <div className="h-40 bg-sneutral-100 rounded-lg"></div>
//         </div>
//       </div>
//     );
...
//         {showInactiveError && inactiveLicenses.length > 0 && (
//           <div className="p-4 bg-warning-50 border border-warning-300 rounded-lg flex items-start gap-3">
//             <span className="text-warning-500 text-xl mt-0.5">🚫</span>
//             <div>
//               <p className="text-warning-700 font-semibold">
//                 Inactive/Expired license{inactiveLicenses.length > 1 ? "s" : ""} detected — cannot submit
...
//         {editingSection && (
//           <div className="bg-info-50 border-l-4 border-info-400 p-4 rounded-md">
//             <div className="flex gap-2">
//               <PiInfo size={24} className="text-info-700 mt-1" />
//               <div>
//                 <p className="text-h6 font-heading font-medium text-info-800">
//                   Admin Review Required
//                 </p>
//                 <p className="text-p3 text-info-700">
...
//         {/* COMPANY DETAILS */}
//         <div id="company-section" className="bg-base-white rounded-lg overflow-hidden border border-pneutral-200">
//           <div className="flex items-center justify-between px-6 py-4 bg-pneutral-50">
//             <div className="flex items-center gap-3">
//               <div className="p-2 rounded-md bg-secondary-100">
//                 <Building2 size={20} className="text-primary-900" />
...
//                     <div className="relative" ref={productDropdownRef}>
//                       <div
//                         className={`w-full h-[52px] px-4 rounded-lg border flex items-center justify-between ${!editingSection ? 'bg-pneutral-50 border-pneutral-100 cursor-not-allowed' : 'bg-base-white border-pneutral-200 cursor-pointer hover:border-secondary-500'}`}
//                         onClick={() => {
//                           if (editingSection && !loadingStates.productTypes) {
//                             setIsProductDropdownOpen(!isProductDropdownOpen);
//                           }
...
//                       {editingSection && isProductDropdownOpen && !loadingStates.productTypes && (
//                         <div className="absolute top-full mt-1 w-full bg-base-white border border-pneutral-200 rounded-lg shadow-xlg z-50 max-h-80 overflow-y-auto">
//                           <div className="p-2 border-b border-pneutral-200 sticky top-0 bg-base-white">
//                             <p className="text-p3 text-pneutral-600 font-medium">
//                               Select product types:
//                             </p>
...
//                     </label>
//                     <div className="flex gap-2">
//                       <div className="w-24 h-[52px] px-4 rounded-lg bg-pneutral-50 border border-pneutral-100 flex items-center">
//                         <span className="text-p4 font-body font-regular text-pneutral-700">+91</span>
//                       </div>
...
//                           maxLength={10}
//                           placeholder="9876543210"
//                           className={`w-full h-[52px] px-4 rounded-lg text-p4 font-body font-regular
//                             ${editingSection
//                               ? `bg-base-white border ${companyPhoneError ? 'border-warning-500 focus:ring-warning-500' : 'border-pneutral-200 focus:outline-none focus:ring-2 focus:ring-secondary-500'}`
//                               : "bg-pneutral-50 border border-pneutral-100 cursor-not-allowed text-pneutral-500"
//                             }`}
//                         />
//                         {companyPhoneError && (
//                           <p className="mt-1 text-p2 text-warning-500">{companyPhoneError}</p>
...
//                 <label className="text-label-l4 font-heading font-medium text-pneutral-900">
//                   <CiMail size={18} className="inline mr-2" />
//                   Coordinator Email ID
//                   <span className="text-warning-500 ml-1">*</span>
//                 </label>
//                 <div className="relative">
...
//                     disabled={!editingSection}
//                     placeholder="coordinator@company.com"
//                     className={`w-full h-[52px] px-4 rounded-lg text-p4 font-body font-regular pr-10
//                       ${editingSection
//                         ? `bg-base-white border ${emailExistsError ? 'border-warning-500 focus:ring-warning-500' : 'border-pneutral-200 focus:outline-none focus:ring-2 focus:ring-secondary-500'} ${emailExistsError ? 'text-pneutral-500' : 'text-pneutral-800'}`
//                         : "bg-pneutral-50 border border-pneutral-100 cursor-not-allowed text-pneutral-500"
//                       }`}
//                   />
//                   {isCheckingEmail && (
...
//                       className={`w-full h-[52px] px-4 rounded-lg text-p4 font-body font-regular pr-10
//                         ${editingSection
//                           ? `bg-base-white border ${coordinatorPhoneError || phoneExistsError ? 'border-warning-500 focus:ring-warning-500' : 'border-pneutral-200 focus:outline-none focus:ring-2 focus:ring-secondary-500'} ${coordinatorPhoneError || phoneExistsError ? 'text-pneutral-500' : 'text-pneutral-800'}`
//                           : "bg-pneutral-50 border border-pneutral-100 cursor-not-allowed text-pneutral-500"
//                         }`}
//                     />
//                     {isCheckingPhone && (
...
//               key={productName}
//               id={`license-section-${productName.replace(/\s/g, '-')}`}
//               className={`${hasLicenseError ? 'border-2 border-warning-300 rounded-lg' : ''}`}
//             >
//               <SectionCard
//                 title={`${productName} License Details`}
//                 icon={<HiOutlineDocumentCheck size={20} />}
...
//               >
//                 {isInactive && licenseData.issueDate && licenseData.expiryDate && (
//                   <div className="mb-4 px-4 py-2.5 bg-warning-50 border border-warning-200 rounded-lg flex items-center gap-2">
//                     <span className="text-warning-500 text-base">⚠️</span>
//                     <p className="text-warning-600 text-p3 font-medium">
//                       {productName} License is inactive/expired. Please update with a valid license.
//                     </p>
...
//                           placeholder="e.g., TN/CBE/20B-12345"
//                           maxLength={30}
//                           className={`w-full h-[52px] px-4 rounded-lg text-p4 font-body font-regular uppercase pr-10
//                             ${editingSection
//                               ? `bg-base-white border border-pneutral-200 focus:outline-none focus:ring-2 focus:ring-secondary-500 ${licenseErrors[productName] || licenseExistsError[productName] ? 'border-warning-500' : ''} ${licenseErrors[productName] || licenseExistsError[productName] ? 'text-pneutral-500' : 'text-pneutral-800'}`
//                               : "bg-pneutral-50 border border-pneutral-100 cursor-not-allowed text-pneutral-500"
//                             }`}
//                         />
//                         {isCheckingLicense[productName] && (
...
//                       />
//                     ) : (
//                       <div className="h-[52px] px-4 rounded-lg bg-pneutral-50 border border-pneutral-100 flex items-center">
//                         <IoCalendarOutline className="mr-2 text-pneutral-600" />
//                         <span className="text-p4 font-body font-regular text-pneutral-800">{licenseData.issueDate ? licenseData.issueDate.toLocaleDateString('en-GB') : '-'}</span>
//                       </div>
//                     )}
...
//                       License Status
//                     </label>
//                     <div className="flex items-center h-[52px] px-4 rounded-lg bg-pneutral-50 border border-pneutral-100">
//                       <div className={`flex items-center gap-2 px-3 py-1 rounded-full ${currentStatus === 'Active' ? 'bg-success-50 text-success-700' : 'bg-warning-50 text-warning-700'
//                         }`}>
//                         <GoCheckCircle size={16} />
//                         <span className="text-p3 font-medium">
//                           {!licenseData.issueDate || !licenseData.expiryDate ? 'Pending' : currentStatus}
...
//                     className={`w-full h-[52px] px-4 rounded-lg text-p4 font-body font-regular uppercase pr-10
//                       ${editingSection
//                         ? `bg-base-white border ${gstExistsError ? 'border-warning-500 focus:ring-warning-500' : 'border-pneutral-200 focus:outline-none focus:ring-2 focus:ring-secondary-500'} ${gstExistsError ? 'text-pneutral-500' : 'text-pneutral-800'}`
//                         : "bg-pneutral-50 border border-pneutral-100 cursor-not-allowed text-pneutral-500"
//                       }`}
//                   />
//                   {isCheckingGST && (
...
// }: any) {
//   return (
//     <div className={`bg-base-white rounded-lg overflow-hidden border ${underReview ? "border-pneutral-200" : "border-pneutral-200"}`}>
//       <div className="flex items-center justify-between px-6 py-4 bg-pneutral-50">
//         <div className="flex items-center gap-3">
//           <div className={`p-2 rounded-md ${iconBg}`}>
//             <div className={iconColor}>{icon}</div>
...
//       <label className="text-label-l4 font-heading font-medium text-pneutral-900">
//         {icon && (
//           <span className="text-pneutral-600 text-lg inline mr-2">
//             {icon}
//           </span>
//         )}
//         {label}
//         {!hideAsterisk && <span className="text-warning-500 ml-1">*</span>}
//       </label>
//       <input
//         type={type}
//         value={value}
...
//         maxLength={maxLength}
//         placeholder={placeholder}
//         className={`w-full h-[52px] px-4 rounded-lg text-p4 font-body font-regular ${className}
//         ${editable
//             ? `bg-base-white border ${error ? 'border-warning-500 focus:ring-warning-500' : 'border-pneutral-200 focus:outline-none focus:ring-2 focus:ring-secondary-500'} ${editable ? 'text-pneutral-500' : 'text-pneutral-800'}`
//             : "bg-pneutral-50 border border-pneutral-100 cursor-not-allowed text-pneutral-500"
//           }
//         `}
//       />
...
//       <div className="relative" ref={dropdownRef}>
//         <div
//           className={`w-full h-[52px] px-4 rounded-lg border flex items-center justify-between cursor-pointer overflow-hidden
//             ${editable && !isDisabled && !isLoading
//               ? "bg-base-white border-pneutral-200 hover:border-secondary-500"
//               : "bg-pneutral-50 border-pneutral-100 cursor-not-allowed"
//             }`}
//           onClick={() => {
//             if (editable && !isDisabled && !isLoading) {
...
//             <span className={`text-p4 font-body font-regular truncate ${!selectedOption ? "text-pneutral-500" : editable ? "text-pneutral-500" : "text-pneutral-800"}`}>
//               {isLoading ? "Loading..." : displayValue}
//             </span>
//           </div>
//           <ChevronDown
...
//         {isOpen && editable && !isDisabled && !isLoading && (
//           <div className="absolute top-full left-0 right-0 mt-1 bg-base-white border border-pneutral-200 rounded-lg shadow-xlg z-50 overflow-hidden">
//             <div className="max-h-60 overflow-y-auto">
//               {options.length > 0 ? (
//                 options.map((opt: any) => (
//                   <div
...
//       {label && (
//         <label className="text-label-l4 font-heading font-medium text-pneutral-900">
//           {label} <span className="text-warning-500 ml-1">*</span>
//         </label>
//       )}

//       {editable ? (
//         <div className="flex items-center justify-between h-[52px] px-3 rounded-lg border-2 border-dashed border-secondary-100 bg-secondary-50">
//           <div className="flex items-center gap-3 flex-1 min-w-0">
//             <div className="bg-base-white rounded-md w-10 h-10 flex items-center justify-center shrink-0">
//               <FileText size={20} className="text-primary-900" />
//             </div>
//             <span className="text-p4 font-body font-regular text-pneutral-800 truncate flex-1">
//               {displayFileName}
//             </span>
//           </div>
...
//             type="button"
//             onClick={handleReplaceClick}
//             className="text-secondary-700 text-p3 font-semibold hover:text-secondary-800 transition-colors ml-3 shrink-0"
//           >
//             Click to replace
//           </button>
...
//             </span>
//             {isPending && (
//               <span className="text-p2 text-warning-600 bg-warning-50 px-2 py-1 rounded-full">
...
//             <button
//               onClick={onDownload}
//               className={`transition-colors ${isPending ? 'text-pneutral-400 cursor-not-allowed' : 'text-primary-900 hover:text-primary-700'}`}
//               title="Download file"
//               disabled={isPending}
//             >
//               <Download size={20} />
...
//             <button
//               onClick={onView}
//               className={`transition-colors ${isPending ? 'text-pneutral-400 cursor-not-allowed' : 'text-pneutral-600 hover:text-pneutral-800'}`}
//               title="Open in new tab"
//               disabled={isPending}
//             >
//               <ExternalLink size={20} />
