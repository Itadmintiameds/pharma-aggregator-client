...
//                 className="group relative px-6 py-3 bg-primary-600 hover:bg-primary-700 text-white font-bold text-base rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 whitespace-nowrap"
//               >
//                 <span className="flex items-center justify-center">
//                   <FaUserPlus className="mr-2" />
//                   Register / Sign Up
...
//               <button
//                 onClick={handleSellerLogin}
//                 className="group relative px-6 py-3 bg-secondary-500 hover:bg-secondary-600 text-white font-bold text-base rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 whitespace-nowrap"
//               >
//                 <span className="flex items-center justify-center">
