...
//   // Helper to prevent consecutive spaces in text fields
// const handleTextInput = (e: React.ChangeEvent<HTMLInputElement>, field: string, maxLength: number, allowSpecialChars = true) => {
//   let value = e.target.value;
  
//   // Replace multiple spaces with single space
//   value = value.replace(/\s{2,}/g, ' ');
  
//   // Remove leading/trailing spaces? (optional - keep as is for now)
...
//   // For landmark, also filter special characters if needed
//   if (field === 'landmark') {
...
// old code without latest global css dated 19.05.2026................
