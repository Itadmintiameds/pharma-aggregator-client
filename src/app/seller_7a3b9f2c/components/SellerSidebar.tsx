...
{index !== steps.length - 1 && (
  ...
  className={` w-10 h-10 sm:w-12 sm:h-12 shrink-0 flex items-center justify-center rounded-xl shadow-md
                  ...
                  <div className="flex-1 min-w-0">
                    <h3
                      className={`text-label-l5 font-heading font-semibold text-pneutral-900 truncate
                      ${isActive ? "text-pneutral-900" : "text-pneutral-900"}`}
                    >
                      {item.title}
                    </h3>
...
// This code is with old global css dated 19.05.2026...............
