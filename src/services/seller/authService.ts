// src/services/seller/authService.ts
...
//       `${this.passwordBaseUrl}/validate-reset-token`,
//       { token }
//     );
//     return {
...
// async resetPasswordWithToken(data: { token: string; newPassword: string }): Promise<ApiResponse<null>> {
//   try {
//     const response = await api.post<ApiResponse<null>>(
//       `${this.passwordBaseUrl}/reset-password-with-token`,
//       data
