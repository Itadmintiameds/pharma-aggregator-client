...
// original service without sms integration................
...
//   async sendSMSOtp(data: SMSOtpRequest): Promise<SMSOtpResponse> {
//     try {
//       const response = await api.post<SMSOtpResponse>('/otp/send', data);
//       return response.data;
//     } catch (error) {
//       console.error('Error sending SMS OTP:', error);
//       throw error;
...
//   async verifySMSOtp(data: SMSVerifyOtpRequest): Promise<SMSOtpResponse> {
//     try {
//       const response = await api.post<SMSOtpResponse>('/otp/verify', data);
//       return response.data;
//     } catch (error) {
//       console.error('Error verifying SMS OTP:', error);
//       throw error;
